...
svclass = SVC(kernel='sigmoid',gamma=1,C=0.1,coef0=1)#kernel method"""             
svclass.fit(X_train,Y_train)
predictions = svclass.predict(X_test) 
"""
...
print( "errorrr:",1-metrics.accuracy_score( Y_test,predictions))